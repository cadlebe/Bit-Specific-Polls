...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for question whose pub_date is in
        the future.
        """
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        """
        If no questions exist, an appropirate message is deisplayed.
        """
    ...
    def test_two_past_questions(self):
        """
        The question index page may display multiple quetions.
        """
